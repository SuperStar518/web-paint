...
go.Diagram.inherit(LineDrawingTool, go.Tool);

  LineDrawingTool.prototype.createTemp = function() {
  //function createTemp() {
      var b = new go.Part();
      b.layerName = "Tool";
      b.selectable = false;
  ...
  * @this {LineDrawingTool}
  */
  LineDrawingTool.prototype.doActivate = function() {
    var diagram = this.diagram;
    if (diagram === null) return;
    this.isActive = true;
    diagram.isMouseCaptured = true;
    this.createTemp();
//    this._tempLine = createTemp();
  ...
  * @this {LineDrawingTool}
  */
  LineDrawingTool.prototype.doDeactivate = function() {
    var diagram = this.diagram;
    if (diagram === null) return;
  ...
  * @this {LineDrawingTool}
  */
  LineDrawingTool.prototype.doMouseMove = function() {
    var diagram = this.diagram;
    if (diagram === null) return;
    if (this.isActive && this.tempLine !== null) {
      LineDrawingTool.updateLineGeometry(diagram.firstInput.documentPoint, diagram.lastInput.documentPoint, this.tempLine);
    }
  };
  ...
  * @this {LineDrawingTool}
  */
  LineDrawingTool.prototype.doMouseUp = function() {
    if (this.isActive) {
      var diagram = this.diagram;
      diagram.remove(this.tempLine);
      try {
  ...
  */
  LineDrawingTool.prototype.insertPart = function(start, end) {
    var diagram = this.diagram;
    ...
    if (part !== null) {
      LineDrawingTool.updateLineGeometry(diagram.firstInput.documentPoint, diagram.lastInput.documentPoint, part);
  ...
  * @name LineDrawingTool#tempLine
  * @function.
  * @return {Part}
  */
  Object.defineProperty(LineDrawingTool.prototype, "tempLine", {
  ...
  * Setting this property does not raise any events.
  * @name LineDrawingTool#delay
  * @function.
  * @return {number}
  */
  Object.defineProperty(LineDrawingTool.prototype, "delay", {
  ...
  * Setting this property does not raise any events.
  * @name LineDrawingTool#archetypeNodeData
  * @function.
  * @return {Object}
  */
  Object.defineProperty(LineDrawingTool.prototype, "archetypeNodeData", {
  ...
  * @param {Part} part
  */
  LineDrawingTool.updateLineGeometry = function(start, end, part) {
